...
import { RunStatus, TaskStatus, AntRole } from "../domain/types";
...
class MockPgPool {
  ...
  public mockClient = {
    ...
    query: async (sql: string, params: any[] = []) => {
      ...
      if (s.startsWith("INSERT INTO RUN_ACCOUNTING_STATE")) {
...
test("PostgreSQL Connection Pool Transaction Mock Unit Tests", async (t) => {
