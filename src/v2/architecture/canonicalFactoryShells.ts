...
const MISSING_RUNTIME_IMPLEMENTATION: CanonicalFactoryImplementation =
  Object.freeze({
    kind: "MISSING_RUNTIME_IMPLEMENTATION" as const,
    stepperBinding: "UNAVAILABLE" as const,
    executionPolicy: "FAIL_CLOSED" as const,
    reasonCode: "CANONICAL_FACTORY_RUNTIME_UNIMPLEMENTED" as const,
  });
