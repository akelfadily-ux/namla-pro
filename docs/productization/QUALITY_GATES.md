...
| PostgreSQL      | UNIT TESTED | UNIT TESTED | MOCK TESTED | MOCK TESTED | UNIT TESTED | MOCK TESTED | UNIT TESTED | MOCK TESTED | `src/infrastructure/persistence/postgresStateRepository.ts`, `src/tools/pglitePostgresEngineTests.ts` |
